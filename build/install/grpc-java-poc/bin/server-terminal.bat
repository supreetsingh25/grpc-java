...
@rem ##########################################################################
@rem
@rem  server-terminal startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and SERVER_TERMINAL_OPTS to pass JVM options to this script.
...
@rem Execute server-terminal
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVER_TERMINAL_OPTS%  -classpath "%CLASSPATH%" io.grpc.communication.example.ServerTerminal %CMD_LINE_ARGS%
...
:fail
rem Set variable SERVER_TERMINAL_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%SERVER_TERMINAL_EXIT_CONSOLE%" exit 1
exit /b 1
